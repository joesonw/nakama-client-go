module github.com/joesonw/nakama-client-go
...
require (
	...
	github.com/heroiclabs/nakama/v3 v3.19.0
...
require (
	...
	gopkg.in/natefinch/lumberjack.v2 v2.0.0-20230206193814-4cb27fcfbb0f // indirect
